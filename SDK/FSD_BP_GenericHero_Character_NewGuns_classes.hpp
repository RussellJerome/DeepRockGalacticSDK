...
#include "FSD_BP_GenericHero_Character_NewGuns_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_GenericHero_Character_NewGuns.BP_GenericHero_Character_NewGuns_C");
		return ptr;
	}
