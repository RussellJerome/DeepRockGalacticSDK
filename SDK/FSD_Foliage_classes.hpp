...
#include "FSD_Foliage_structs.hpp"
...
public:
	...
	int STATIC_FoliageOverlappingBoxCount(class UObject** WorldContextObject, class UStaticMesh** StaticMesh, struct FCoreUObject_FBox* Box);
};
