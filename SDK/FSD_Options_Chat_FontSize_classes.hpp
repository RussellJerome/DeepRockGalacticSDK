...
#include "FSD_Options_Chat_FontSize_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass Options_Chat_FontSize.Options_Chat_FontSize_C");
		return ptr;
	}
