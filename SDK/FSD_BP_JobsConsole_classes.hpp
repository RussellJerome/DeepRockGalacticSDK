...
#include "FSD_BP_JobsConsole_structs.hpp"
...
public:
	...
	class UStaticMeshComponent*                        Mesh_Monitor;                                             // 0x0338(0x0008) (BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_JobsConsole.BP_JobsConsole_C");
		return ptr;
	}
