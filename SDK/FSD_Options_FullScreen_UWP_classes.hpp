...
#include "FSD_Options_FullScreen_UWP_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass Options_FullScreen_UWP.Options_FullScreen_UWP_C");
		return ptr;
	}
