...
#include "FSD_Sandblasted_MapWidget_structs.hpp"
...
class USandblasted_MapWidget_C : public UITM_MisSel_BiomeBase_C
{
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass Sandblasted_MapWidget.Sandblasted_MapWidget_C");
		return ptr;
	}
