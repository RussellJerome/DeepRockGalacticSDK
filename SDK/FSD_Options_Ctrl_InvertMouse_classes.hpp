...
#include "FSD_Options_Ctrl_InvertMouse_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass Options_Ctrl_InvertMouse.Options_Ctrl_InvertMouse_C");
		return ptr;
	}
