...
#include "FSD_BP_Widget_DropPod_DangerLevel_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_Widget_DropPod_DangerLevel.BP_Widget_DropPod_DangerLevel_C");
		return ptr;
	}
