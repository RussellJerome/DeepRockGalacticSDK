...
#include "FSD_Options_MouseSmooting_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass Options_MouseSmooting.Options_MouseSmooting_C");
		return ptr;
	}
