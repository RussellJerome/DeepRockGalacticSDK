...
#include "FSD_AugmentedReality_structs.hpp"
...
public:
	...
	struct FCoreUObject_FBox                           BoundingBox;                                              // 0x0050(0x001C) (Edit, ZeroConstructor, IsPlainOldData)
	...
	void SetBoundingBox(struct FCoreUObject_FBox* InBoundingBox);
	class FString GetFriendlyName();
	TArray<unsigned char> GetCandidateObjectData();
	struct FCoreUObject_FBox GetBoundingBox();
};
