...
#include "FSD_UI_InfirmaryStats_Item_structs.hpp"
...
public:
	...
	class AFSDPlayerState*                             Player_State;                                             // 0x0290(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, IsPlainOldData)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass UI_InfirmaryStats_Item.UI_InfirmaryStats_Item_C");
		return ptr;
	}
	...
	void MissonStatUpdate(class UMissionStat** MissionStat, struct FText* StatValue);
