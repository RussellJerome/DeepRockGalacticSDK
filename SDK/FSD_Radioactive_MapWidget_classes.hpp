...
#include "FSD_Radioactive_MapWidget_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass Radioactive_MapWidget.Radioactive_MapWidget_C");
		return ptr;
	}
