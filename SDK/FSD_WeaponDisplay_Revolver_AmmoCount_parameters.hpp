...
#include "FSD_WeaponDisplay_Revolver_AmmoCount_classes.hpp"
...
struct UWeaponDisplay_Revolver_AmmoCount_C_SetTotalCount_Params
{
	int*                                               Value;                                                    // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
};

// Function WeaponDisplay_Revolver_AmmoCount.WeaponDisplay_Revolver_AmmoCount_C.SetClipCount
struct UWeaponDisplay_Revolver_AmmoCount_C_SetClipCount_Params
{
	int*                                               Value;                                                    // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
};
...
struct UWeaponDisplay_Revolver_AmmoCount_C_ExecuteUbergraph_WeaponDisplay_Revolver_AmmoCount_Params
{
