...
#include "FSD_Options_HoldToSprint_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass Options_HoldToSprint.Options_HoldToSprint_C");
		return ptr;
	}
