...
#include "FSD_ConsoleScreen_CharCustomization_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass ConsoleScreen_CharCustomization.ConsoleScreen_CharCustomization_C");
		return ptr;
	}
