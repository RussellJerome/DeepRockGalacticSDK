...
#include "FSD_HUD_CroNewGrenadeLauncher_parameters.hpp"
...
void UHUD_CroNewGrenadeLauncher_C::OnSpreadChanged(float* HorizontalSpread, float* VerticalSpread, bool* isAtRest)
{
	...
	UHUD_CroNewGrenadeLauncher_C_OnSpreadChanged_Params params;
...
void UHUD_CroNewGrenadeLauncher_C::SetData(class AItem** Item)
{
	...
	UHUD_CroNewGrenadeLauncher_C_SetData_Params params;
	params.Item = Item;
...
void UHUD_CroNewGrenadeLauncher_C::Construct()
{
	...
	UHUD_CroNewGrenadeLauncher_C_Construct_Params params;
...
void UHUD_CroNewGrenadeLauncher_C::PreConstruct(bool* IsDesignTime)
{
	...
	UHUD_CroNewGrenadeLauncher_C_PreConstruct_Params params;
...
void UHUD_CroNewGrenadeLauncher_C::OnDamagedEnemy_Event(TScriptInterface<class UHealth>* EnemyHealth, float* Damage, float* DamageModifier, float* HealthRemaining)
{
	...
	UHUD_CroNewGrenadeLauncher_C_OnDamagedEnemy_Event_Params params;
...
void UHUD_CroNewGrenadeLauncher_C::ExecuteUbergraph_HUD_CroNewGrenadeLauncher(int* EntryPoint)
{
	...
	UHUD_CroNewGrenadeLauncher_C_ExecuteUbergraph_HUD_CroNewGrenadeLauncher_Params params;
