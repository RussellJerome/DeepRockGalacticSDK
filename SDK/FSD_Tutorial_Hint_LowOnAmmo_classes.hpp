...
#include "FSD_Tutorial_Hint_LowOnAmmo_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Tutorial_Hint_LowOnAmmo.Tutorial_Hint_LowOnAmmo_C");
		return ptr;
	}
