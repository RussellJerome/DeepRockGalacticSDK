...
#include "FSD_HUD_CroDualMachinePistols_parameters.hpp"
...
void UHUD_CroDualMachinePistols_C::OnDamagedEnemy_Event(TScriptInterface<class UHealth>* EnemyHealth, float* Damage, float* DamageModifier, float* HealthRemaining)
{
