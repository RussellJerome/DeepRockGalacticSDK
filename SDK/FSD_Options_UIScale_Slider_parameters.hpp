...
#include "FSD_Options_UIScale_Slider_classes.hpp"
...
struct UOptions_UIScale_Slider_C_Construct_Params
{
};
...
struct UOptions_UIScale_Slider_C_BndEvt__Basic_Slider_K2Node_ComponentBoundEvent_9_OnValueChanged__DelegateSignature_Params
{
	float*                                             Value;                                                    // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
};

// Function Options_UIScale_Slider.Options_UIScale_Slider_C.ExecuteUbergraph_Options_UIScale_Slider
struct UOptions_UIScale_Slider_C_ExecuteUbergraph_Options_UIScale_Slider_Params
{
	int*                                               EntryPoint;                                               // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
};

// Function Options_UIScale_Slider.Options_UIScale_Slider_C.OnVolumeChanged__DelegateSignature
struct UOptions_UIScale_Slider_C_OnVolumeChanged__DelegateSignature_Params
{
