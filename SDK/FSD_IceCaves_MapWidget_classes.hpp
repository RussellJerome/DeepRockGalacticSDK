...
#include "FSD_IceCaves_MapWidget_structs.hpp"
...
class UIceCaves_MapWidget_C : public UITM_MisSel_BiomeBase_C
{
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass IceCaves_MapWidget.IceCaves_MapWidget_C");
		return ptr;
	}
