...
#include "FSD_Options_GFX_Sharpening_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass Options_GFX_Sharpening.Options_GFX_Sharpening_C");
		return ptr;
	}
