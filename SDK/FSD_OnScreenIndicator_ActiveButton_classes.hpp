...
#include "FSD_OnScreenIndicator_ActiveButton_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass OnScreenIndicator_ActiveButton.OnScreenIndicator_ActiveButton_C");
		return ptr;
	}
