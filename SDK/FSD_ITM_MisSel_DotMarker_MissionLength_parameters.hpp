...
#include "FSD_ITM_MisSel_DotMarker_MissionLength_classes.hpp"
...
struct UITM_MisSel_DotMarker_MissionLength_C_PreConstruct_Params
{
	bool*                                              IsDesignTime;                                             // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
};

// Function ITM_MisSel_DotMarker_MissionLength.ITM_MisSel_DotMarker_MissionLength_C.SetData
struct UITM_MisSel_DotMarker_MissionLength_C_SetData_Params
{
...
struct UITM_MisSel_DotMarker_MissionLength_C_ExecuteUbergraph_ITM_MisSel_DotMarker_MissionLength_Params
{
