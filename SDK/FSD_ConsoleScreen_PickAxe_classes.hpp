...
#include "FSD_ConsoleScreen_PickAxe_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass ConsoleScreen_PickAxe.ConsoleScreen_PickAxe_C");
		return ptr;
	}
