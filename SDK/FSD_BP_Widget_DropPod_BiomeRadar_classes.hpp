...
#include "FSD_BP_Widget_DropPod_BiomeRadar_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_Widget_DropPod_BiomeRadar.BP_Widget_DropPod_BiomeRadar_C");
		return ptr;
	}
