...
#include "FSD_HUD_Armor_Base_structs.hpp"
...
public:
	...
	class UHealthComponent*                            HealthComponent;                                          // 0x0250(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, InstancedReference, IsPlainOldData)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass HUD_Armor_Base.HUD_Armor_Base_C");
		return ptr;
	}
