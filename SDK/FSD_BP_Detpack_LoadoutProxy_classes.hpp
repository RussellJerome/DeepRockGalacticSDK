...
#include "FSD_BP_Detpack_LoadoutProxy_structs.hpp"
...
class ABP_Detpack_LoadoutProxy_C : public ALoadoutItemProxy
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_Detpack_LoadoutProxy.BP_Detpack_LoadoutProxy_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_Detpack_LoadoutProxy(int* EntryPoint);
};
