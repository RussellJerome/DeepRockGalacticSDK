...
#include "FSD_OnScreenIndicator_SlowGrenade_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass OnScreenIndicator_SlowGrenade.OnScreenIndicator_SlowGrenade_C");
		return ptr;
	}
