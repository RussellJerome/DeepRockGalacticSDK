...
#include "FSD_Options_PhotosensitivityMode_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass Options_PhotosensitivityMode.Options_PhotosensitivityMode_C");
		return ptr;
	}
