...
#include "FSD_HUD_Cro_BoltActionRifle_parameters.hpp"
...
void UHUD_Cro_BoltActionRifle_C::OnDamagedEnemy_Event(TScriptInterface<class UHealth>* EnemyHealth, float* Damage, float* DamageModifier, float* HealthRemaining)
{
	...
	UHUD_Cro_BoltActionRifle_C_OnDamagedEnemy_Event_Params params;
...
void UHUD_Cro_BoltActionRifle_C::Construct()
{
	...
	UHUD_Cro_BoltActionRifle_C_Construct_Params params;
...
void UHUD_Cro_BoltActionRifle_C::OnSpreadChanged(float* HorizontalSpread, float* VerticalSpread, bool* isAtRest)
{
	...
	UHUD_Cro_BoltActionRifle_C_OnSpreadChanged_Params params;
...
void UHUD_Cro_BoltActionRifle_C::SetData(class AItem** Item)
{
	...
	UHUD_Cro_BoltActionRifle_C_SetData_Params params;
	params.Item = Item;
...
void UHUD_Cro_BoltActionRifle_C::PreConstruct(bool* IsDesignTime)
{
	...
	UHUD_Cro_BoltActionRifle_C_PreConstruct_Params params;
...
void UHUD_Cro_BoltActionRifle_C::ExecuteUbergraph_HUD_Cro_BoltActionRifle(int* EntryPoint)
{
	...
	UHUD_Cro_BoltActionRifle_C_ExecuteUbergraph_HUD_Cro_BoltActionRifle_Params params;
