...
#include "FSD_UI_Forge_Completed_classes.hpp"
...
struct UUI_Forge_Completed_C_OnKeyUp_Params
{
...
struct UUI_Forge_Completed_C_Show_Params
{
...
struct UUI_Forge_Completed_C_Construct_Params
{
};

// Function UI_Forge_Completed.UI_Forge_Completed_C.OnIntroStarted
struct UUI_Forge_Completed_C_OnIntroStarted_Params
{
};
...
struct UUI_Forge_Completed_C_BndEvt__ContinueButton_K2Node_ComponentBoundEvent_0_OnClicked__DelegateSignature_Params
{
};
...
struct UUI_Forge_Completed_C_BndEvt__UI_Forge_Details_K2Node_ComponentBoundEvent_1_OnMatrixCoreOpened__DelegateSignature_Params
{
};

// Function UI_Forge_Completed.UI_Forge_Completed_C.ClickContinue
struct UUI_Forge_Completed_C_ClickContinue_Params
{
};

// Function UI_Forge_Completed.UI_Forge_Completed_C.ExecuteUbergraph_UI_Forge_Completed
struct UUI_Forge_Completed_C_ExecuteUbergraph_UI_Forge_Completed_Params
{
	int*                                               EntryPoint;                                               // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
};

// Function UI_Forge_Completed.UI_Forge_Completed_C.OnFinished__DelegateSignature
struct UUI_Forge_Completed_C_OnFinished__DelegateSignature_Params
{
};
