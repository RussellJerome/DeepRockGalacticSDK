...
#include "FSD_Magma_MapWidget_structs.hpp"
...
class UMagma_MapWidget_C : public UITM_MisSel_BiomeBase_C
{
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass Magma_MapWidget.Magma_MapWidget_C");
		return ptr;
	}
