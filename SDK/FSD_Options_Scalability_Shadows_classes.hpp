...
#include "FSD_Options_Scalability_Shadows_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass Options_Scalability_Shadows.Options_Scalability_Shadows_C");
		return ptr;
	}
