...
#include "FSD_Options_Scalability_Textures_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass Options_Scalability_Textures.Options_Scalability_Textures_C");
		return ptr;
	}
	...
	void UINeedsUpdate();
	void ShowOptions();
	void BndEvt__Basic_OptionSwitcher_K2Node_ComponentBoundEvent_9_OnSelectionChanged__DelegateSignature(struct FText* Value, int* Index);
