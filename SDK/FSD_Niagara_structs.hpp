...
struct FNiagaraVMExecutableDataId
{
	...
	TArray<class FString>                              AdditionalDefines;                                        // 0x0028(0x0010) (ZeroConstructor)
...
struct FNiagaraVMExecutableData
{
	...
	class FString                                      LastHlslTranslation;                                      // 0x00F0(0x0010) (ZeroConstructor)
	class FString                                      LastHlslTranslationGPU;                                   // 0x0100(0x0010) (ZeroConstructor)
	class FString                                      LastAssemblyTranslation;                                  // 0x0110(0x0010) (ZeroConstructor)
	...
	TArray<class FString>                              ParameterCollectionPaths;                                 // 0x0138(0x0010) (ZeroConstructor)
	...
	class FString                                      ErrorMsg;                                                 // 0x0150(0x0010) (ZeroConstructor)
...
struct FNiagaraVariableInfo
{
	...
	struct FText                                       Definition;                                               // 0x0030(0x0028)
...
{
	TMap<struct FName, class FString>                  PropertyMetaData;                                         // 0x0000(0x0050) (Edit, ZeroConstructor)
	struct FText                                       Description;                                              // 0x0050(0x0028) (Edit)
	struct FText                                       CategoryName;                                             // 0x0068(0x0028) (Edit)
