...
#include "FSD_IceCaves_MapWidget_parameters.hpp"
...
{
	static auto fn = UObject::FindObject<UFunction>("Function IceCaves_MapWidget.IceCaves_MapWidget_C.GetBasePanel");

	UIceCaves_MapWidget_C_GetBasePanel_Params params;
