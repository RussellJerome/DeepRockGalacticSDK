...
#include "FSD_HUD_RadarPoint_Resupply_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass HUD_RadarPoint_Resupply.HUD_RadarPoint_Resupply_C");
		return ptr;
	}
