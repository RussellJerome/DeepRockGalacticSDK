...
#include "FSD_BP_JumpBoots_parameters.hpp"
...
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_JumpBoots.BP_JumpBoots_C.Receive_ActivatePerk");
...
void UBP_JumpBoots_C::ExecuteUbergraph_BP_JumpBoots(int* EntryPoint)
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_JumpBoots.BP_JumpBoots_C.ExecuteUbergraph_BP_JumpBoots");
