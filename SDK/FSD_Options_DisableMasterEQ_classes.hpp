...
#include "FSD_Options_DisableMasterEQ_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass Options_DisableMasterEQ.Options_DisableMasterEQ_C");
		return ptr;
	}
