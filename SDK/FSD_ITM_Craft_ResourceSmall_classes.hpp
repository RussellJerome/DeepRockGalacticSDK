...
#include "FSD_ITM_Craft_ResourceSmall_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass ITM_Craft_ResourceSmall.ITM_Craft_ResourceSmall_C");
		return ptr;
	}
