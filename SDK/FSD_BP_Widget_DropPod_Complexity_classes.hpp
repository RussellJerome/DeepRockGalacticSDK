...
#include "FSD_BP_Widget_DropPod_Complexity_structs.hpp"
...
{
public:
	class UWidgetComponentCustomMaterial*              WidgetComponentCustomMaterial;                            // 0x0330(0x0008) (BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_Widget_DropPod_Complexity.BP_Widget_DropPod_Complexity_C");
		return ptr;
	}
