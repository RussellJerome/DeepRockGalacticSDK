...
#include "FSD_HUD_RadarPoint_Donkey_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass HUD_RadarPoint_Donkey.HUD_RadarPoint_Donkey_C");
		return ptr;
	}
