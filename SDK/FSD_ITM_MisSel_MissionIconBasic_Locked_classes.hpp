...
#include "FSD_ITM_MisSel_MissionIconBasic_Locked_structs.hpp"
...
public:
	...
	bool                                               Border;                                                   // 0x0250(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               ThickOutline;                                             // 0x0251(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass ITM_MisSel_MissionIconBasic_Locked.ITM_MisSel_MissionIconBasic_Locked_C");
		return ptr;
	}
