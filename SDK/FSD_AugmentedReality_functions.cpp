...
#include "FSD_AugmentedReality_parameters.hpp"
...
// Parameters:
// struct FCoreUObject_FBox*      InBoundingBox                  (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData)

void UARCandidateObject::SetBoundingBox(struct FCoreUObject_FBox* InBoundingBox)
{
...
// (Final, Native, Public, HasDefaults, BlueprintCallable, BlueprintPure, Const)
// Parameters:
// struct FCoreUObject_FBox       ReturnValue                    (ConstParm, Parm, OutParm, ZeroConstructor, ReturnParm, ReferenceParm, IsPlainOldData)

struct FCoreUObject_FBox UARCandidateObject::GetBoundingBox()
{
