...
#include "FSD_HUD_CroNewAssaultRifle_parameters.hpp"
...
void UHUD_CroNewAssaultRifle_C::OnDamagedEnemy_Event(TScriptInterface<class UHealth>* EnemyHealth, float* Damage, float* DamageModifier, float* HealthRemaining)
{
