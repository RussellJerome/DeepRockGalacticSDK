...
#include "FSD_Options_InvertMouseWheel_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass Options_InvertMouseWheel.Options_InvertMouseWheel_C");
		return ptr;
	}
