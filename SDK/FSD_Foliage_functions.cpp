...
#include "FSD_Foliage_parameters.hpp"
...
// class UObject**                WorldContextObject             (Parm, ZeroConstructor, IsPlainOldData)
// class UStaticMesh**            StaticMesh                     (ConstParm, Parm, ZeroConstructor, IsPlainOldData)
// struct FCoreUObject_FBox*      Box                            (Parm, ZeroConstructor, IsPlainOldData)
// int                            ReturnValue                    (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)

int UFoliageStatistics::STATIC_FoliageOverlappingBoxCount(class UObject** WorldContextObject, class UStaticMesh** StaticMesh, struct FCoreUObject_FBox* Box)
{
