...
#include "FSD_BP_Widget_DropPod_GarbageGen_structs.hpp"
...
class ABP_Widget_DropPod_GarbageGen_C : public AActor
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_Widget_DropPod_GarbageGen.BP_Widget_DropPod_GarbageGen_C");
		return ptr;
	}
