...
#include "FSD_Options_ShowSubtitles_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass Options_ShowSubtitles.Options_ShowSubtitles_C");
		return ptr;
	}
