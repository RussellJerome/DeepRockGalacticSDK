...
#include "FSD_FungusBogs_MapWidget_structs.hpp"
...
class UFungusBogs_MapWidget_C : public UITM_MisSel_BiomeBase_C
{
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass FungusBogs_MapWidget.FungusBogs_MapWidget_C");
		return ptr;
	}
