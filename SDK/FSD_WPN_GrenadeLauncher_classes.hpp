...
#include "FSD_WPN_GrenadeLauncher_structs.hpp"
...
public:
	...
	class UProjectileLauncherComponent*                ProjectileLauncher;                                       // 0x0748(0x0008) (BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData)
