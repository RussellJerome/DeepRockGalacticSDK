...
#include "FSD_Options_MixerInteractivitySteam_parameters.hpp"
...
void UOptions_MixerInteractivitySteam_C::PrintNotInEditor(class FString* inString)
{
...
void UOptions_MixerInteractivitySteam_C::MixerHandleUser(class FString* UserName)
{
