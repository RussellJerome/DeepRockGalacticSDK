...
#include "FSD_Options_UseStreamerProgram_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass Options_UseStreamerProgram.Options_UseStreamerProgram_C");
		return ptr;
	}
