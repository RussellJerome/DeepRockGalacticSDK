...
#include "FSD_WeaponDisplay_Pistol_AmmoCount2_classes.hpp"
...
struct UWeaponDisplay_Pistol_AmmoCount2_C_SetTotalCount_Params
{
	int*                                               Value;                                                    // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
};

// Function WeaponDisplay_Pistol_AmmoCount2.WeaponDisplay_Pistol_AmmoCount2_C.SetClipCount
struct UWeaponDisplay_Pistol_AmmoCount2_C_SetClipCount_Params
{
	int*                                               Value;                                                    // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
};
...
struct UWeaponDisplay_Pistol_AmmoCount2_C_ExecuteUbergraph_WeaponDisplay_Pistol_AmmoCount2_Params
{
